...
Let's start with the money graph: the websites that most uniquely define right-wing and left-wing information sources in this Twitter archive.
...
For each domain (the root website like *youtube.com*, as opposed to *youtube.com/somevideo*), I calculated its share of the links tweeted in the right-wing and left-wing hashtags. For example, youtube.com is the root domain for approximately 4% of the links shared in right-wing hashtags, but only about 2% of the links shared in left-wing hashtags. We can divide those shares to get an *odds ratio*, a statistical measurement that tells us if a website is more likely to pop up in right-wing tweets, left-wing tweets, or equally likely to pop up in either. So if we divide youtube.com's odds of appearing in right-wing tweets by its odds of appearing in left-wing tweets, we get an odds ratio of 2, meaning it's twice as likely to appear in a right-wing tweet than a left-wing tweet. This graph shows the domains with the largest left-leaning and right-leaning odds ratios (on a logarithmic scale to make the visualization easier to read).

On the graphic above, we can see that left-wing tweets are biased in favor of Twitter, Instagram, and mainstream news sources. Though there are some left-leaning partisan sites on the list, the list is dominated by mainstream sources like the New York Times, Politico, Sky News, CNN, Washington Post, and The Guardian. On the right, however, there are **no mainstream news sources.** Aside from YouTube (mostly independent "news" sources), most links come from far-right sites like Breitbart, fake-news sites like TruthFeed, and ad-tech/malware sites like theatlantic.ga and USAToday24h.ml.

There are several important takeaways from this graphic. First **mainstream news media tend to appear more commonly in left-wing hashtags.** Does this demonstrate that the "liberal media" is a real thing? Or do right-leaning tweeters simply distrust the mainstream media because of a "liberal media" myth? I tend to think the latter, but this study isn't equipped to address that particular question. Second, though there are left-wing fake news sites further down the list, **the most characteristic right-wing sites include a large number of fake news sites.** However, I don't think this means that right-wing Twitter users are more likely to be sharers of misinformation per se, and that's because of the way that fake content is shared. Specifically, **the presence of malware sites suggests a significant bot presence in right-wing hashtags.**
...
The content is generated by others, there are minimal webhosting costs involved, and even the "click-bait" properties of the "ads" are engineered by others. Scripts abound on the internet for mining Twitter content and remixing it to make your own content. (I have my students do this in more artful, ethical ways.) So this is a pretty simple way to make at least a few bucks on the internet without much technical knowledge.
